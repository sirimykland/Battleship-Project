...
class MainMenuState : MenuState() {
    ...
    val mathchmakingButton = TextButton(
        Gdx.graphics.width / 2 - 150f,
        Gdx.graphics.height - 200f,
        300f,
        150f,
        "Matchmaking"
    ) { GameStateManager.set(MatchmakingState()) }
    val settingsButton = TextButton(
        ...
        150f,
        "Settings"
    ) { GameStateManager.set(SettingsState()) }
    ...
    val testButton = TextButton(
        Gdx.graphics.width / 2 - 150f,
        Gdx.graphics.height - 800f,
        300f,
        150f,
        "Testmenu"

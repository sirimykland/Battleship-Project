...
/**
 * Interface containing all functions for accessing firebase, is used because the implementation
 * for setting up a connection to firebase is different for desktop and android.
 */
@Suppress("UNCHECKED_CAST")
interface FirebaseController {
    //Needs to be set for the different platforms
    val db : Firestore
